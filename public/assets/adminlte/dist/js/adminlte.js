            ...
            _proto.fixLayoutHeight = function fixLayoutHeight(extra) {
                ...
                if (offset !== false) {
                    if (max === heights.control_sidebar) {
                        $(Selector.CONTENT).css('min-height', max + offset - 6);
                    } else if (max === heights.window) {
                        $(Selector.CONTENT).css('min-height', max + offset - heights.header - heights.footer - 6);
                    } else {
                        $(Selector.CONTENT).css('min-height', max + offset - heights.header - 6);
                    }

                    if (this._isFooterFixed()) {
                        $(Selector.CONTENT).css('min-height', parseFloat($(Selector.CONTENT).css('min-height')) + heights.footer - 6);
                    }
                }
