...
return [
    'admin_dir'            => env('ADMIN_DIR', 'panel'),
    'default-theme'        => env('DEFAULT_THEME', 'default'),
    'base_name'            => env('APP_NAME', 'Flexcodes Technologies'),
    ...
    'purifier'                     => [
        'default'           => [
            ...
            'URI.SafeIframeRegexp'     => env('CMS_IFRAME_FILTER_URL_REGEX',
                '%^(http://|https://|//)('.env('CMS_IFRAME_ALLOWED_URLS', 'www.youtube.com/embed/|player.vimeo.com/video/').')%'),
    ...
    'demo'                         => [
        'account' => [
            ...
            'password' => env('CMS_DEMO_ACCOUNT_PASSWORD', '123456'),
        ],
    ],
    'google_fonts'                 => [
        'Aclonica',
