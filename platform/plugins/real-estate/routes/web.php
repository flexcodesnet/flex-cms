...
use FXC\RealEstate\Models\Category;
use FXC\RealEstate\Models\Project;
use FXC\RealEstate\Models\Property;
use Illuminate\Support\Facades\Route;

Route::group(['namespace' => 'FXC\RealEstate\Http\Controllers', 'middleware' => ['web', 'core']], function () {
    Route::group([
...
Route::group([
    'namespace'  => 'FXC\LanguageAdvanced\Http\Controllers',
    'middleware' => ['web', 'core'],
], function () {
    Route::group([
        'prefix'     => 'account',
